...
export const SvgFinalComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M687.494 145L687 309.5" stroke="url(#y-gradient-slate-line)" />
    <path d="M687.5 361.5L687.006 526" stroke="url(#y-gradient-slate-line)" />
    <path
    ...
    <path
      ...
      stroke="url(#x-gradient-purple-line-right-left)"
    />
    <path d="M532.5 329V300L629 237" stroke="url(#y-gradient-slate-line)" />
    <path d="M842.5 331V302L746 239" stroke="url(#y-gradient-slate-line)" />
    <path d="M523 159V103.5L566 64V0" stroke="url(#y-gradient-red-line)" />
    <path d="M851 159V103.5L808 64V0" stroke="url(#y-gradient-red-line)" />
    <path
    ...
    <path
      ...
      stroke="var(--color-purple-100)"
    />
    <path d="M290.5 651H548.5M462 543V777" stroke="var(--color-purple-100)" />
    <path
    ...
    <path
      ...
      stroke="var(--color-purple-100)"
    />
    <path d="M1089.5 651H828M913 543V777" stroke="var(--color-purple-100)" />
    <path
      d="M287.5 495V594C287.5 600.627 292.873 606 299.5 606H381L407.5 574.5V431.5L431.5 406.5H532.5"
      stroke="var(--color-purple-100)"
    />
