    ...
    <div className="">
            ...
            <span className="relative ml-1 inline-block h-7.5 w-[10rem] overflow-hidden rounded-sm border border-neutral-100 bg-gradient-to-r from-yellow-100 via-white to-red-100 md:ml-3 md:h-14 md:w-[22rem]">
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="absolute top-0 left-0 bg-gradient-to-r from-blue-600 via-cyan-500 to-green-400 mask-t-from-70% bg-clip-text py-1 pl-2 text-start text-transparent"
                >
                  {delivery[index]}
                </motion.span>
              </AnimatePresence>
      ...
      `,
            ...
            <ul className="relative z-10 mt-2 list-disc pl-6 tracking-wide text-neutral-600">
              <li>Understand business goals, workflows, and expectations</li>
              <li>Identify core features and technology requirements</li>
      ...
      `,
            ...
            <ul className="relative z-10 mt-2 list-disc pl-6 tracking-wide text-neutral-600">
              <li>Plan system structure for scalability and performance</li>
              <li>Create intuitive user interface and experience flow</li>
      ...
      `,
            ...
            <ul className="relative z-10 mt-2 list-disc pl-6 tracking-wide text-neutral-600">
              <li>Build core features with clean and maintainable code</li>
              <li>Implement secure backend and responsive frontend</li>
      ...
      `,
            ...
            <ul className="relative z-10 mt-2 list-disc pl-6 tracking-wide text-neutral-600">
              <li>Validate functionality across all use cases</li>
      ...
      `,
            ...
            <ul className="relative z-10 mt-2 list-disc pl-6 tracking-wide text-neutral-600">
              <li>Deploy on cloud or preferred infrastructure</li>
