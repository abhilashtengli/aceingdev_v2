  ...
  return (
    <>
      <div className="w-full items-center justify-center border-red-600 px-32 py-4">
        ...
        <div className="flex w-full items-center justify-center gap-x-32 py-12">
          <div className="relative h-fit w-[30rem] rounded-lg border px-5 py-4">
            <svg
              width="357"
              height="1"
              viewBox="0 0 357 1"
            ...
            <div className="mt-6 flex justify-end">
              <Link
                className="group flex w-fit items-center gap-x-2 rounded-sm border border-neutral-300 px-2 py-1 font-semibold tracking-wide text-neutral-800 shadow-lg transition duration-300 active:scale-85"
                to="/"
              >
                Learn more
  ...
  /* <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-2">
                ...
                <div className="flex items-center gap-x-2">
                  <svg
                    ...
                    stroke-width="0"
                    viewBox="0 0 24 24"
                    className="h-4 w-4 shrink-0 stroke-[0.5px] text-cyan-600 md:h-6 md:w-6"
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div className="flex items-center gap-x-2">
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 shrink-0 stroke-1 text-[#ffd60a] md:h-6 md:w-6"
                  >
