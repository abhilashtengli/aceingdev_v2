  ...
  <>
    ...
    <div className="flex items-center gap-x-1">
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="h-4 w-4 shrink-0 stroke-1 text-black md:h-6 md:w-6"
      >
    ...
    <div className="flex items-center gap-x-1">
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="h-4 w-4 shrink-0 stroke-1 text-green-700 md:h-6 md:w-6"
      >
        <g clipPath="url(#clip0_714_22)">
          <path
    ...
    <div className="flex items-center gap-x-1">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-4 w-4 shrink-0 stroke-1 text-yellow-600 md:h-6 md:w-6"
        viewBox="0 0 128 128"
      >
        <path
          stroke="currentColor"
      ...
      <p className="text-sm font-semibold tracking-wide text-yellow-600">
        Express.js
      </p>
    </div>
  </>
