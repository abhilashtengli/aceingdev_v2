            ...
            <section className="items-center justify-center border-blue-500 py-12">
              ...
              <div className="flex items-center justify-center">
                <p className="mt-4 max-w-xl pl-5 leading-7 font-medium tracking-wide text-neutral-600">
                  ...
                  data fetching, dynamic report generation, and secure
                  dashboards, the system eliminated hours of manual effort and
                  reduced errors, while enabling the client to scale and
                  monetize their services. The outcome is a future ready SaaS
                  product that turns reporting into a matter of minutes
                  reliable, efficient, and built for growth.
                </p>
              </div>
            </section>
          </div>
