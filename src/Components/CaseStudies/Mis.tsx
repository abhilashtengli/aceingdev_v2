...
import misImg from "@/assets/mis_mainpage.webp";
            ...
            <div className="mt-8 flex">
              <div className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-neutral-300 p-1 md:h-8 md:w-8">
                <svg
                  ...
                  className="h-4 w-4 stroke-1 text-sky-600 md:h-8 md:w-8"
                >
              ...
              <div className="-ml-3 flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-neutral-300 bg-white p-1 md:h-8 md:w-8">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 text-green-600 md:h-8 md:w-8"
                  viewBox="0 0 128 128"
                >
                  <path
                    stroke="currentColor"
              ...
              <div className="-ml-3 flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-neutral-300 bg-white p-1 md:h-8 md:w-8">
                <svg
                  ...
                  stroke-width="0"
                  viewBox="0 0 24 24"
                  className="h-4 w-4 text-sky-600 md:h-8 md:w-8"
                  height="1em"
                  width="1em"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <div className="-ml-3 flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-neutral-300 bg-white p-1 md:h-8 md:w-8">
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 pt-2 text-yellow-400 md:h-8 md:w-8"
                >
              ...
              <div className="-ml-3 flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-neutral-300 bg-white p-1 md:h-8 md:w-8">
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 text-yellow-400 md:h-8 md:w-8"
                >
          ...
          <div className="mt-3 flex justify-center">
            <div className="max-w-[45rem] border-r border-dashed border-purple-200 pr-16 pl-1">
              <p className="text-md max-w-7xl leading-6 tracking-wider text-neutral-700">
                A Central Government Institution required a digital platform to
                strengthen the millet ecosystem. The vision was to provide a one
                stop hub where Sellers, buyers, policymakers, and researchers
                could access resources, trade millet products, explore
                government schemes, and collaborate for sustainable millet
                adoption.
              </p>
            </div>
            <div className="max-w-5xl pl-16">
              <div className="text-md space-y-5 leading-6 tracking-wider text-neutral-700">
                <p>
                  The institution identified key challenges faced by the millet
                  ecosystem including lack of structured marketplace, limited
                  expert access, and poor visibility of government schemes.
                </p>
                <p>
                  Stakeholders needed a comprehensive digital solution that
                  could connect all participants in the millet value chain while
                  providing educational resources and real-time insights.
                </p>
              </div>
            </div>
          </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-md tracking-wide text-gray-700">
                          ...
                          farmer-to-buyer connections for better profitability.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="from-red-25 border-r bg-gradient-to-b to-transparent p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-md tracking-wide text-gray-700">
                          Government schemes and policies were poorly accessible
                          to farmers.
                        </p>
                      </div>
                    </div>
            ...
            <div className="w-full pl-8">
              <ul className="text-md mt-5 max-w-xl font-medium tracking-wide text-neutral-600">
                {[
                  ...
                  "Empowered farmers with real-time insights and knowledge resources.",
                  "Strengthened collaboration via community discussions and expert mentoring.",
                  "Drove awareness and adoption of millets as a climate-resilient crop.",
                  "Established a scalable digital foundation for future expansion.",
                ].map((text, idx) => (
          ...
          <section className="items-center justify-center border-blue-500 py-12">
            ...
            <div className="flex items-center justify-center">
              <p className="mt-4 max-w-xl pl-5 leading-7 font-medium tracking-wide text-neutral-600">
                ...
                government scheme integration, expert consultations, and
                community engagement, the platform has empowered farmers to
                become more profitable, resilient, and connected. This project
                not only delivered a scalable solution for today's needs but
                also laid the foundation for future digital innovation in
                agriculture.
              </p>
            </div>
          </section>
...
export default MilletInformationSystem;
