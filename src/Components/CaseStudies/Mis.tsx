            ...
            <div className="mt-3 flex flex-col justify-center md:flex-row">
              <div className="border-r border-dashed border-purple-200 pl-1 md:max-w-[45rem] md:pr-16">
                <p className="text-md text-sm leading-6 tracking-wider text-neutral-700 md:text-lg">
                  ...
                  researchers could access resources, trade millet products,
                  explore government schemes, and collaborate for sustainable
                  millet adoption.
                </p>
              </div>
              <div className="mt-4 max-w-5xl md:mt-0 md:pl-16">
                <div className="text-md space-y-5 text-sm leading-6 tracking-wider text-neutral-700 md:text-lg">
                  <p>
                    ...
                    limited expert access, and poor visibility of government
                    schemes.
                  </p>
                  <p>
                    Stakeholders needed a comprehensive digital solution that
                    could connect all participants in the millet value chain
                    while providing educational resources and real-time
                    insights.
                  </p>
                </div>
              </div>
