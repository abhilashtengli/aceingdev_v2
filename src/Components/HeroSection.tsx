  ...
  return (
    <div className="flex w-full flex-col items-center justify-center">
          ...
          <div className="max-w-4xl">
            <h1 className="relative mb-4 text-5xl leading-[1.2] font-bold tracking-widest text-neutral-700">
              ...
              <span className="relative z-10 border-red-500 dark:mask-t-from-60%">
                Solving Business <br /> problems With{" "}
          ...
          <div className="absolute grid h-full w-full grid-cols-[1.35fr_1.65fr] place-content-center justify-items-center border-red-500">
            <div className="mt-24 ml-24 grid grid-cols-[1.35fr_1.65fr] gap-x-8 border-red-600">
              <div className="mt-2 space-y-6 perspective-distant transform-3d">
                <div className="h-[15rem] rounded-xl border-neutral-300 p-2">
                  <div className="via-neutral-40 relative h-full w-full overflow-hidden rounded-xl border-neutral-200">
                    ...
                    <div className="relative top-44 flex h-[400px] w-full flex-col items-center justify-center overflow-hidden"></div>
                  </div>
                </div>
      ...
      `,
                    ...
                    className="w-[25rem] rounded-xl border border-neutral-300 bg-white/[0.7] bg-[radial-gradient(var(--color-neutral-300)_1px,transparent_1px)] [background-size:15px_15px] shadow-lg"
                  >
                    <div className="h-fit w-full gap-y-2 border-b border-neutral-100 py-3 text-center">
                      ...
                      <p className="text-sm">From concept to Reality</p>
                    </div>
                    <div className="mb-2 grid h-fit grid-cols-2 place-content-center justify-items-center border-red-600 py-1">
                      <div className="relative grid grid-cols-1 gap-4">
                        <motion.div
                          onHoverStart={startIdeaAnimating}
                          className="group/bulb flex h-full w-full cursor-pointer flex-col items-center justify-between rounded-lg border border-neutral-300 p-2 hover:bg-white"
                        >
                          ...
                          <div className="flex flex-col items-center justify-center pl-0.5">
                            <h1 className="text-md font-semibold text-neutral-500">
                              Idea
                            </h1>
                            <div ref={ideaScope}>
                        ...
                        <motion.div
                          ...
                          className="group/product flex h-full w-full cursor-pointer flex-col items-center justify-between gap-1 rounded-lg border border-neutral-300 p-2 hover:bg-white"
                        >
              ...
              <div className="mt-32 space-y-6">
                <div className="flex flex-col items-center justify-center gap-y-8 rounded-xl border-neutral-400 p-3 pt-6">
                  <WritingCodeAnimationComponent />
                  <div className="group/ct rounded-[11px] border border-neutral-300 bg-gradient-to-l from-purple-200 via-neutral-50 to-neutral-100 px-2 py-2">
                    <div
                      style={{
                        backgroundImage: `
